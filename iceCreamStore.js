...
let totalFlavor = Object.keys(flavorDistribution);

const result = Object.keys(flavorDistribution).reduce((a,b) => flavorDistribution[a] > flavorDistribution[b] ? a:b);

console.log(`가장 많이 팔린 아이스크림은 ${result}맛 입니다.`);